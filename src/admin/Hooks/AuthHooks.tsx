...
export const AuthHooks = ()=>{
    ...
    const signInWithEmailAndPassword = async({email, password, setLoading}:signinProps)=>{
        setLoading(true);
        try{
            const response = await fetch('https://magsresidenceserver.vercel.app/user/signuser',{
            method:"POST",
            headers:{
  ...
  const forgotPassword = async (email:string)=>{
    try{
        const response = await fetch('https://magsresidenceserver.vercel.app/user/forgot-password',{
            method:"post",
            headers:{
                "Content-Type":"application/json"
            },
  ...
  const resetPassword = async ({email, token, newPassword, resetForm}:resetpassword)=>{
    try{
        const response = await fetch('https://magsresidenceserver.vercel.app/user/reset-password',{
            method:"post",
            headers:{
                "Content-Type":"application/json"
            },
