...
export const ApartmentForm = ({
  ...
  // --------------------------------------------------
  // CHECK IF A DATE FALLS INSIDE AN EXISTING BOOKING
  // --------------------------------------------------
  ...
  /*
   * We keep the current Formik values here so the
   * disabledCheckOutDate function can determine
   * whether a date is before the selected check-in.
   */
                ...
                >
                  <DatePicker
                    ...
                    onChange={(date) => {
                      ...
                      /*
                       * If the new check-in date
                       * makes the existing checkout
                       * invalid, clear checkout.
                       */
                      if (
                        date &&
                        formik.values
            ...
            {nights > 0 && (
              ...
              {/* -------------------------------- */}
               ...
               <div>
                ...
                <small style={{color:"gray"}}>**Protected by secure, encrypted booking </small>
